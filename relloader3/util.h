...
/*
    Rounds a value down to an alignment (must be a power of 2)
*/
#define ALIGN_DOWN_TO(val, align) ((val) & ~((align)-1))
...
#define writeBranchLink(ptr, offset, destination) \
    relloader3::_writeBranch(((u8 *)(ptr)) + (offset), (void *)(destination), true)
